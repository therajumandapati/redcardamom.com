 ...
 * @subpackage Cardamomrecipe/public
 */
...
class Cardamomrecipe_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/cardamomrecipe-public.js', array( 'jquery' ), $this->version, false );
