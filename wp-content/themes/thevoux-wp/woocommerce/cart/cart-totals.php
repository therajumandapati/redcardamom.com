...
?>
<div class="widget cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

	<strong><span><?php _e( 'Shopping Bag Totals','thevoux' ); ?></span></strong>

	<table cellspacing="0" class="shop_table order_table">

		<tr class="cart-subtotal">
			<th colspan="3"><?php _e( 'Cart Subtotal','thevoux' ); ?></th>
		...
		<tr class="order-total">
			<th colspan="3"><?php _e( 'Order Total','thevoux' ); ?></th>
	...
	$checkout_url = WC()->cart->get_checkout_url();
		...
		echo '<a href="' . $checkout_url . '" class="checkout-button button wc-forward full">' . __( 'Proceed to Checkout', 'woocommerce' ) . '</a>'; ?>
</div>