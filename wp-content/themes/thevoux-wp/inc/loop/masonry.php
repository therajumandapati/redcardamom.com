<article itemscope itemtype="http://schema.org/Article" <?php post_class('post style-masonry'); ?> id="post-<?php the_ID(); ?>" role="article">
	...
	<figure class="post-gallery <?php do_action('thb_is_gallery'); ?><?php do_action('thb_is_review'); ?>">
		...
		<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail('thevoux-masonry',array('itemprop'=>'image')); ?></a>
	</figure>
	<?php } ?>
		<?php if(has_category()) { ?>
