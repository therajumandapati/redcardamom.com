...
<div id="shortcode-generator">
	...
	<div class="shortcode-content">
		...
		<div class="content"><select id="thb-shortcodes" data-placeholder="' . __("Choose a shortcode", 'thevoux') .'">
	    <option></option>';
...
<link rel="stylesheet" href="<?php echo THB_THEME_ROOT; ?>/inc/tinymce/shortcode_generator/css/chosen/chosen.min.css" />
...
<?php echo $shortcode_html . $html_options;  ?>
	...
	<a class="thb-btn" id="add-shortcode"><?php echo __( 'Add Shortcode', 'thevoux' ); ?></a>
